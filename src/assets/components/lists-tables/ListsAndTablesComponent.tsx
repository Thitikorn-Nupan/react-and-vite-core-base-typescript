    ...
    private table1StudentsNoLoop() : JSX.Element {
        return (
            <div className={"container w-50"}>
                ...
                <table className="table mt-3 " style={{margin: "0 auto"}}>
                    ...
                    {/**
                             ...
                             () => this.<function>(<args>)
                    */}
                    <tr style={{"cursor": "pointer"}} className={this.state.styleRow1}
                        onClick={() => this.handle1OnRowClick(this.students[0])}>
                        <td>{this.students[0].sid}</td>
                        <td>{this.students[0].fullname}</td>
                        <td>{this.students[0].age}</td>
                    </tr>
                    <tr style={{"cursor": "pointer"}} className={this.state.styleRow2}
                        onClick={() => this.handle1OnRowClick(this.students[1])}>
                        <td>{this.students[1].sid}</td>
                        <td>{this.students[1].fullname}</td>
                        <td>{this.students[1].age}</td>
                    </tr>
                    <tr style={{"cursor": "pointer"}} className={this.state.styleRow3}
                        onClick={() => this.handle1OnRowClick(this.students[2])}>
        ...
        return (
            <>
                <div className={"container w-50 mt-4"}>
                    <h3 className={"alert alert-primary"}>** With Loop</h3>
                    <table className="table mt-3 " style={{margin: "0 auto"}}>
                        <thead className="table-dark">
                        <tr>
                            <th>Id</th>
