    ...
    render() : JSX.Element  {
        ...
        return (
            <div className={"container mt-4"}>
                ...
                {this.state.option ? this.component : null}
            </div>
        );
    }
}
...
// No props but have to create prop because props and state are always together
...
class ReadAndReadsDataList extends Component<PropsReadAndReadsDataList, StateReadAndReadsDataList> {
    ...
    constructor(props: PropsReadAndReadsDataList) {
        ...
        // ** initial state
        this.state = {robotIdSelected: null}
        ...
        return (
            <div>
                ...
                <table className="table mt-3 w-50" style={{margin: "0 auto"}}>
                    ...
                    <tbody>
                    {
                        this.robotsCanChange.map((robot : Robot) => (
                            <tr key={robot.rid}
